...
<div class="top-bar">
    ...
    <div class="top-bar--section socials">
        <a title="Facebook" href="https://www.facebook.com/beanandherb" target="_blank" rel="noopener">
            <svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                <path d="M1343 12v264h-157q-86 0-116 36t-30 108v189h293l-39 296h-254v759h-306v-759h-255v-296h255v-218q0-186 104-288.5t277-102.5q147 0 228 12z" fill="#fff"/>
            </svg>
            <span class="screen-reader-text">Facebook page opens in new window</span>
        </a>
        <a title="Twitter" href="https://twitter.com/beanandherb" target="_blank" rel="noopener">
            <svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
        ...
        <a title="Instagram" href="https://www.instagram.com/beanandherb/" target="_blank" rel="noopener">
            <svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
        ...
        <a title="LinkedIn" href="ttps://www.linkedin.com/company/beanandherb/" target="_blank" rel="noopener">
            <svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
